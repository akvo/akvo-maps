...
function decrypt(secret, initializationVector, cipherText) {
  ...
  var ivBuffer = Buffer.from(initializationVector, 'base64');
  var cipher = crypto.createDecipheriv("aes-256-cbc", keyBuffer, ivBuffer);
